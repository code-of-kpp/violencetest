...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ViolentPhoto'
        db.create_table(u'stopviolence_violentphoto', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('short_name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('phnto_link', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('news_link', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('violent_level', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'stopviolence', ['ViolentPhoto'])


    def backwards(self, orm):
        # Deleting model 'ViolentPhoto'
        db.delete_table(u'stopviolence_violentphoto')
